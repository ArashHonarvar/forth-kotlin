class Forth {
    ...
    private var hashMap :MutableMap <String,String> = mutableMapOf<String,String>();
    ...
    private fun calculateUserFunc(string :String){
            if(string.startsWith(":") && string.endsWith(";")){
                ...
                var splitted = subString.split(" ")
                val func = splitted[0]
                if (func.toIntOrNull() != null) {
                    throw Exception("illegal operation")
                }
                //getting the func value without the name
                subString = subString.replaceFirst(splitted[0].plus(" ") , "",true);
                splitted = subString.split(" ")
